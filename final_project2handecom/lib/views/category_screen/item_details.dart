        ...
        children: [
          Expanded(
            ...
            VxRating(
              ...
              10.heightBox,
              "\$30,000".text.color(mainGreen).fontFamily(bold).size(18).make(),
                ...
                children: [
                  ...
                  //total row
                   Row(
                    ...
                    "\$0.00".text.color(mainGreen).size(16).fontFamily(bold).make(),
                    ],
              ...
              10.heightBox,
              //i copied this widget from home screen featired products
            ...
            SizedBox(
              ...
              height: 60,
              child: ourButton(color: mainGreen, onPress: (){}, textColor: whiteColor, title: "Add to cart"),
            ),
        ],
      ),
    );
