...
import 'package:final_project2handecom/views/home_screen/components/featured_button.dart';
import 'package:final_project2handecom/widgets_common/home_button.dart';
           ...
           child: Column(
            ...
            Row(
              ...
              children: List.generate(3, (index) => homeButtons(
                ...
                title: index == 0? topCatagories : index == 1? brand : topSellers,
              )),
            ),
            ...
            Container(
                    ...
                    child: Row(
                      children: List.generate(6, (index) => Column(
                        ...
                        children: [
                          ...
                          10.heightBox,
                          "\$600".text.color(mainGreen).fontFamily(bold).size(16).make()                      
                          ],
              ...
              GridView.builder(
                ...
                shrinkWrap: true,
                itemCount: 6,
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 8, crossAxisSpacing: 8, mainAxisExtent: 300), itemBuilder: (BuildContext context, int index) { 
                 return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
